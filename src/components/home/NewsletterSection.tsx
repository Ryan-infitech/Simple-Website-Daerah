    ...
    <section className="py-16 bg-primary-600 text-white">
      <div className="container-custom">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">Dapatkan Informasi Terbaru</h2>
          <p className="text-primary-100 mb-8">
            Berlangganan newsletter kami untuk mendapatkan informasi terkini tentang wisata,
            acara, dan perkembangan terbaru di Solok Selatan.
          </p>
