          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-8">
                ...
                lanjut tentang Solok Selatan, jangan ragu untuk menghubungi kami
                melalui:
              </p>
            ...
            <div className="space-y-4">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  Bagaimana cara menuju ke Solok Selatan?
                </h3>
                <p className="text-gray-600">
                  Solok Selatan dapat diakses melalui jalan darat dari Kota
                  Padang dengan jarak tempuh sekitar 3-4 jam. Tersedia juga
                  transportasi umum seperti bus dan travel dari Terminal Padang
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  Kapan waktu terbaik untuk mengunjungi Solok Selatan?
                </h3>
                <p className="text-gray-600">
                  Waktu terbaik untuk mengunjungi Solok Selatan adalah pada
                  musim kemarau (Mei-September) karena cuaca cenderung cerah dan
                  cocok untuk aktivitas outdoor. Namun, keindahan alam Solok
                  Selatan tetap bisa dinikmati sepanjang tahun.
                </p>
              </div>

              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">
                  Apakah ada akomodasi untuk wisatawan di Solok Selatan?
                </h3>
                <p className="text-gray-600">
                  Ya, tersedia berbagai pilihan akomodasi mulai dari hotel,
                  homestay, hingga penginapan sederhana di berbagai lokasi di
                  Solok Selatan. Untuk pengalaman budaya yang lebih autentik,
                  beberapa desa wisata juga menyediakan homestay di rumah
                  penduduk lokal.
                </p>
              </div>
